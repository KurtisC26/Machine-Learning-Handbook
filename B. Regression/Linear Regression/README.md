For a simple Linear Regression model, we will leverage the LinearRegression model from sklearn.linear_model.LinearRegression. This model is a Ordinary least squares Linear Regression.
